...
const zh = {
  ...
  // ---- 顶部导航 ----
  overview: '概览', teams: '空间', shared: '分享', trash: '回收站', admin: '管理',
  // ---- 文件浏览：视图切换与筛选 ----
  ...
  searchModeHint: '检索模式：结果跨越全部可见空间目录（标签/收藏过滤）。',
  ...
  statMyFiles: '我的文件', statStorage: '存储占用', statTeamFiles: '其他空间文件',
  ...
  linkShownOnCreate: '链接创建时已展示', grantedAccess: '授权用户/空间访问',
  // ---- 设置 ----
  ...
  // ---- 空间（统一空间模型） ----
  teamsTitle: '空间', createTeamTitle: '创建空间', teamNameLabel: '空间名称',
  teamDescLabel: '描述（可选）', creating: '创建中…',
  teamsEmpty: '还没有空间，创建一个开始协作吧', teamLoadFailed: '加载空间失败',
  teamCreateFailed: '创建空间失败', teamUpdateFailed: '更新空间失败', teamDeleteFailed: '删除空间失败',
  deleteTeamConfirm: '解散空间“{name}”？', noDesc: '暂无描述', createdAt: '创建于',
  // ---- 空间成员与设置 ----
  membersTitle: '成员（{n}）', addMember: '添加成员', roleLabel: '角色',
  ownerOnlyHint: '仅空间 owner/admin 可管理成员与用户组。', membersLoadFailed: '加载成员失败',
  addMemberFailed: '添加成员失败', removeMemberFailed: '移除成员失败', changeRoleFailed: '修改角色失败',
  memberSearchPlaceholder: '搜索成员（昵称/用户名）…',
  spaceManage: '空间管理', invitesTab: '邀请',
  spaceManageShort: '管理', dissolveShort: '解散',
  spaceManageReadOnly: '你在本空间无管理权限（只读）：可查看成员与用户组，变更需联系空间 owner/admin。',
  spaceSelectManage: '管理空间', memberPanelHint: '暂无成员',
  inviteMember: '邀请成员', noMatchingMembers: '没有匹配的成员',
  transferOwner: '转让所有权', transferOwnerConfirm: '把空间所有权转让给「{name}」？你将降为管理员。',
  transferOwnerFailed: '转让所有权失败', leaveTeam: '离开空间',
  leaveTeamConfirm: '确定离开空间「{name}」？离开后将失去该空间的访问权限。',
  leaveTeamFailed: '离开空间失败', dissolveTeam: '解散空间',
  dissolveTeamConfirm: '解散空间「{name}」？空间内全部文件将被删除，不可恢复。',
  teamSettings: '空间设置', storageUsedLabel: '存储用量', myRoleLabel: '我的角色',
  ...
  roleOwnerTip: '全部权限 + 解散空间 / 转让所有权（唯一）',
  ...
  batchRemoveConfirm: '移除 {n} 名成员？成员将立即失去空间访问权限。',
  ...
  dissolveDangerZone: '危险区', dissolveTeamTypeName: '输入空间名称「{name}」以确认解散：',
  dissolveTeamNameMismatch: '空间名称不一致',
  // ---- 加入空间（邀请落地页） ----
  joinTeamTitle: '加入空间', joinTeamSuccess: '已加入空间「{name}」',
  joinTeamAlready: '你已是该空间成员', joinTeamFailed: '加入空间失败',
  joinTeamOpen: '进入空间', joinTeamList: '返回空间列表',
  permRead: '读取', permWrite: '写入', permDelete: '删除', permShare: '分享', permAdmin: '管理',
  // ---- 空间配额 ----
  quotaLabel: '存储配额', quotaUnlimited: '不限', quotaBytesLabel: '配额（字节，0=不限）',
  quotaUpdateFailed: '更新配额失败', quotaUsedOf: '{used} / {quota}',
  defaultSpaceBadge: '默认空间', defaultSpaceNoDelete: '默认空间不可删除（可改名）',
  // ---- 空间用户组 ----
  groupsTitle: '用户组（{n}）', groupsTab: '用户组', membersTab: '成员',
  addGroup: '添加用户组', groupCol: '用户组', groupMemberCountCol: '组内成员',
  addGroupFailed: '添加用户组失败', removeGroupFailed: '移除用户组失败',
  changeGroupRoleFailed: '修改用户组角色失败', noGroups: '暂无用户组',
  groupPermHint: '用户组与直接成员并存时，权限取两者最高。',
  // ---- Excalidraw 白板（v1.3） ----
  ...
  aclHint: '路径级 ACL：allow 授予、deny 显式拒绝（优先于空间角色）。保存时整体覆盖全部条目。',
  ...
  aclSubjectUser: '用户', aclSubjectTeam: '空间', aclSubjectRole: '角色',
}
...
const en: { [K in keyof typeof zh]: string } = {
  ...
  // ---- Top navigation ----
  overview: 'Overview', teams: 'Spaces', shared: 'Shared', trash: 'Trash', admin: 'Admin',
  ...
  searchModeHint: 'Search mode: results span all visible space folders (tag/starred filters).',
  ...
  statMyFiles: 'My files', statStorage: 'Storage used', statTeamFiles: 'Other spaces files',
  ...
  linkShownOnCreate: 'Link was shown on creation', grantedAccess: 'Granted users/spaces',
  // ---- Settings ----
  ...
  // ---- Spaces (unified space model) ----
  teamsTitle: 'Spaces', createTeamTitle: 'Create space', teamNameLabel: 'Space name',
  teamDescLabel: 'Description (optional)', creating: 'Creating…',
  teamsEmpty: 'No spaces yet — create one to start collaborating', teamLoadFailed: 'Failed to load spaces',
  teamCreateFailed: 'Failed to create space', teamUpdateFailed: 'Failed to update space', teamDeleteFailed: 'Failed to delete space',
  deleteTeamConfirm: 'Dissolve space “{name}”?', noDesc: 'No description', createdAt: 'Created at',
  // ---- Space members & settings ----
  membersTitle: 'Members ({n})', addMember: 'Add member', roleLabel: 'Role',
  ownerOnlyHint: 'Only space owner/admin can manage members and groups.', membersLoadFailed: 'Failed to load members',
  addMemberFailed: 'Failed to add member', removeMemberFailed: 'Failed to remove member', changeRoleFailed: 'Failed to change role',
  memberSearchPlaceholder: 'Search members (nickname/username)…',
  spaceManage: 'Manage space', invitesTab: 'Invites',
  spaceManageShort: 'Manage', dissolveShort: 'Dissolve',
  spaceManageReadOnly: 'You have read-only access to this space: view members and groups; ask the owner/admin for changes.',
  spaceSelectManage: 'Manage space', memberPanelHint: 'No members yet',
  inviteMember: 'Invite member', noMatchingMembers: 'No matching members',
  transferOwner: 'Transfer ownership', transferOwnerConfirm: 'Transfer space ownership to “{name}”? You will become an admin.',
  transferOwnerFailed: 'Failed to transfer ownership', leaveTeam: 'Leave space',
  leaveTeamConfirm: 'Leave space “{name}”? You will lose access to it.',
  leaveTeamFailed: 'Failed to leave space', dissolveTeam: 'Dissolve space',
  dissolveTeamConfirm: 'Dissolve space “{name}”? All files in it will be deleted permanently.',
  teamSettings: 'Space settings', storageUsedLabel: 'Storage used', myRoleLabel: 'My role',
  ...
  roleOwnerTip: 'All permissions + dissolve space / transfer ownership (unique)',
  ...
  batchRemoveConfirm: 'Remove {n} members? They will immediately lose access to the space.',
  ...
  dissolveDangerZone: 'Danger zone', dissolveTeamTypeName: 'Type the space name “{name}” to confirm:',
  dissolveTeamNameMismatch: 'Space name does not match',
  // ---- Join space (invite landing) ----
  joinTeamTitle: 'Join space', joinTeamSuccess: 'Joined space “{name}”',
  joinTeamAlready: 'You are already a member of this space', joinTeamFailed: 'Failed to join space',
  joinTeamOpen: 'Open space', joinTeamList: 'Back to spaces',
  permRead: 'Read', permWrite: 'Write', permDelete: 'Delete', permShare: 'Share', permAdmin: 'Admin',
  // ---- Space quota ----
  quotaLabel: 'Storage quota', quotaUnlimited: 'Unlimited', quotaBytesLabel: 'Quota (bytes, 0 = unlimited)',
  quotaUpdateFailed: 'Failed to update quota', quotaUsedOf: '{used} / {quota}',
  defaultSpaceBadge: 'Default space', defaultSpaceNoDelete: 'Default space cannot be deleted (rename allowed)',
  // ---- Space groups ----
  groupsTitle: 'Groups ({n})', groupsTab: 'Groups', membersTab: 'Members',
  addGroup: 'Add group', groupCol: 'Group', groupMemberCountCol: 'Group members',
  addGroupFailed: 'Failed to add group', removeGroupFailed: 'Failed to remove group',
  changeGroupRoleFailed: 'Failed to change group role', noGroups: 'No groups yet',
  groupPermHint: 'When groups and direct members coexist, the highest permission wins.',
  ...
  // ---- Path-level ACL (space, v1.3) ----
  acl: 'Permissions', aclTitle: 'Permissions for “{name}”',
  aclHint: 'Path-level ACL: allow grants, deny explicitly overrides space roles. Saving replaces all entries.',
  ...
  aclSubjectUser: 'User', aclSubjectTeam: 'Space', aclSubjectRole: 'Role',
}
