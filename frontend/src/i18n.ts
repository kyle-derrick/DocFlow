...
const zh = {
  ...
  // ---- 顶部导航 ----
  overview: '概览', teams: '空间', shared: '分享', trash: '回收站', admin: '平台管理',
  // ---- 文件浏览：视图切换与筛选 ----
  ...
  // ---- AI 能力第一版 ----
  aiAssistant: 'AI 助手', aiAssistantTitle: 'AI 助手', aiAssistantPlaceholder: '输入问题，Enter 发送…',
  aiAssistantSend: '发送', aiAssistantClear: '清空会话', aiAssistantRAG: '联网我的文件',
  aiAssistantRAGHint: '开启后基于你可见的文件检索回答，并附来源链接',
  aiAssistantSources: '来源', aiAssistantSourcesEmpty: '未检索到相关文件',
  aiAssistantEmpty: '向 AI 助手提问，或点击下方快捷操作。',
  aiAssistantErr: 'AI 请求失败', aiAssistantNotConfigured: '尚未配置 AI Provider，请联系管理员在「管理 → AI 设置」中添加。',
  aiAssistantSummarizeCurrent: '总结当前文件', aiAssistantNoFile: '当前页面没有关联文件',
  aiAssistantGenerating: '生成中…',
  aiAssistantNewChat: '新对话', aiAssistantStop: '停止', aiAssistantStopped: '已停止',
  aiAssistantRetry: '重试', aiAssistantCopy: '复制', aiAssistantCopied: '已复制', aiAssistantRegenerate: '重新生成',
  aiAssistantWelcome: '你好，我是 AI 助手', aiAssistantWelcomeHint: '问我任何问题，或从下面的建议开始。',
  aiAssistantSummarizeDoc: '总结当前文档', aiAssistantCurrentFile: '当前文档',
  aiAssistantSuggestOutline: '帮我规划一份文档大纲', aiAssistantSuggestExplain: '用通俗的语言解释一个概念',
  aiAssistantSuggestPolish: '帮我润色一段文字', aiAssistantSuggestIdeas: '列出可以继续研究的问题',
  aiAssistantInputHint: 'Enter 发送 · Shift + Enter 换行',
  aiEdit: 'AI', aiEditSummary: '摘要', aiEditContinue: '续写', aiEditPolish: '润色', aiEditTranslateZh: '翻译为中文',
  aiEditTranslateEn: '翻译为英文', aiEditCustom: '自定义指令…', aiEditCustomLabel: '自定义 AI 指令',
  aiEditPreview: 'AI 输出预览', aiEditInsert: '插入', aiEditReplace: '替换', aiEditDiscard: '放弃', aiEditRegenerate: '重新生成',
  aiEditSelection: '（作用于选区）', aiEditWhole: '（作用于全文）', aiEditRunning: 'AI 处理中…',
  aiDrawioGenerate: 'AI 生成', aiDrawioTitle: 'AI 生成图表（Mermaid）', aiDrawioPrompt: '用自然语言描述想要的流程图 / 时序图…',
  aiDrawioGenerateBtn: '生成', aiDrawioPreview: '预览', aiDrawioCopy: '复制代码', aiDrawioSaveFile: '保存为 .mmd 文件',
  aiDrawioSaved: '已保存 mermaid 文件', aiDrawioSaveFailed: '保存失败', aiDrawioInsertHint: '在 draw.io 中：菜单 排列 → 插入 → 高级 → Mermaid… 粘贴代码即可插入画布。',
  aiDrawioEmpty: '请先输入图表描述', aiDrawioFailed: '生成失败',
  adminAI: 'AI 设置', adminAIProviders: 'Provider 列表', adminAIProvider: 'Provider',
  adminAIKind: '类型', adminAIBaseURL: 'Base URL', adminAIModel: '模型', adminAIAPIKey: 'API Key',
  adminAIAPIKeyHint: '留空保持现有密钥不变', adminAIEnabled: '启用', adminAIDefault: '默认 Provider',
  adminAITemperature: '温度', adminAIMaxTokens: '最大 tokens', adminAIRateLimit: '每用户每分钟上限',
  adminAITest: '测试连接', adminAITesting: '测试中…', adminAITestOk: '连接成功（{ms} ms）', adminAITestFailed: '连接失败',
  adminAINew: '新建 Provider', adminAIEdit: '编辑', adminAIDelete: '删除', adminAISave: '保存',
  adminAIEnvProvider: 'env 配置', adminAIUsage: 'AI 用量统计', adminAIUsageEmpty: '暂无用量记录',
  adminAIUsageUser: '用户', adminAIUsageCalls: '调用次数', adminAIUsageTokens: 'Tokens',
  adminAIUsageAvgMs: '平均耗时', adminAIFrom: '开始日期', adminAITo: '结束日期',
  adminAIMockHint: '无真实 API Key 时可新建类型为 Mock 的 Provider 用于演示。',
  adminAIKeyConfigured: '已配置', adminAIKeyNotConfigured: '未配置',
  // ---- 路径级 ACL（空间，v1.3） ----
...
const en: { [K in keyof typeof zh]: string } = {
  ...
  // ---- Top navigation ----
  overview: 'Overview', teams: 'Spaces', shared: 'Shared', trash: 'Trash', admin: 'Platform Admin',
  ...
  // ---- AI v1 ----
  aiAssistant: 'AI assistant', aiAssistantTitle: 'AI Assistant', aiAssistantPlaceholder: 'Ask anything, Enter to send…',
  aiAssistantSend: 'Send', aiAssistantClear: 'Clear', aiAssistantRAG: 'Search my files',
  aiAssistantRAGHint: 'Answer with retrieval over files you can access, with source links',
  aiAssistantSources: 'Sources', aiAssistantSourcesEmpty: 'No matching files',
  aiAssistantEmpty: 'Ask the AI assistant, or use a quick action below.',
  aiAssistantErr: 'AI request failed', aiAssistantNotConfigured: 'No AI provider configured yet; ask the administrator to add one in Admin → AI settings.',
  aiAssistantSummarizeCurrent: 'Summarize current file', aiAssistantNoFile: 'No file is open on this page',
  aiAssistantGenerating: 'Generating…',
  aiAssistantNewChat: 'New chat', aiAssistantStop: 'Stop', aiAssistantStopped: 'Stopped',
  aiAssistantRetry: 'Retry', aiAssistantCopy: 'Copy', aiAssistantCopied: 'Copied', aiAssistantRegenerate: 'Regenerate',
  aiAssistantWelcome: 'Hi, I am your AI assistant', aiAssistantWelcomeHint: 'Ask me anything, or start with a suggestion below.',
  aiAssistantSummarizeDoc: 'Summarize this document', aiAssistantCurrentFile: 'Current file',
  aiAssistantSuggestOutline: 'Draft a document outline for me', aiAssistantSuggestExplain: 'Explain a concept in plain words',
  aiAssistantSuggestPolish: 'Polish a paragraph for me', aiAssistantSuggestIdeas: 'Suggest questions worth exploring',
  aiAssistantInputHint: 'Enter to send · Shift + Enter for newline',
  aiEdit: 'AI', aiEditSummary: 'Summarize', aiEditContinue: 'Continue writing', aiEditPolish: 'Polish', aiEditTranslateZh: 'Translate to Chinese',
  aiEditTranslateEn: 'Translate to English', aiEditCustom: 'Custom instruction…', aiEditCustomLabel: 'Custom AI instruction',
  aiEditPreview: 'AI output preview', aiEditInsert: 'Insert', aiEditReplace: 'Replace', aiEditDiscard: 'Discard', aiEditRegenerate: 'Regenerate',
  aiEditSelection: ' (selection)', aiEditWhole: ' (whole document)', aiEditRunning: 'AI is working…',
  aiDrawioGenerate: 'AI generate', aiDrawioTitle: 'AI diagram (Mermaid)', aiDrawioPrompt: 'Describe the flowchart / sequence diagram you want…',
  aiDrawioGenerateBtn: 'Generate', aiDrawioPreview: 'Preview', aiDrawioCopy: 'Copy code', aiDrawioSaveFile: 'Save as .mmd file',
  aiDrawioSaved: 'Mermaid file saved', aiDrawioSaveFailed: 'Failed to save', aiDrawioInsertHint: 'In draw.io: menu Extras → Insert → Advanced → Mermaid…, paste the code to insert into the canvas.',
  aiDrawioEmpty: 'Describe the diagram first', aiDrawioFailed: 'Generation failed',
  adminAI: 'AI settings', adminAIProviders: 'Providers', adminAIProvider: 'Provider',
  adminAIKind: 'Kind', adminAIBaseURL: 'Base URL', adminAIModel: 'Model', adminAIAPIKey: 'API key',
  adminAIAPIKeyHint: 'Leave empty to keep the current key', adminAIEnabled: 'Enabled', adminAIDefault: 'Default provider',
  adminAITemperature: 'Temperature', adminAIMaxTokens: 'Max tokens', adminAIRateLimit: 'Per-user per-minute limit',
  adminAITest: 'Test connection', adminAITesting: 'Testing…', adminAITestOk: 'Connected ({ms} ms)', adminAITestFailed: 'Connection failed',
  adminAINew: 'New provider', adminAIEdit: 'Edit', adminAIDelete: 'Delete', adminAISave: 'Save',
  adminAIEnvProvider: 'env config', adminAIUsage: 'AI usage', adminAIUsageEmpty: 'No usage records',
  adminAIUsageUser: 'User', adminAIUsageCalls: 'Calls', adminAIUsageTokens: 'Tokens',
  adminAIUsageAvgMs: 'Avg latency', adminAIFrom: 'From date', adminAITo: 'To date',
  adminAIMockHint: 'Without a real API key, create a Mock provider for a full demo.',
  adminAIKeyConfigured: 'configured', adminAIKeyNotConfigured: 'not configured',
